defmodule EventAppWeb.EventControllerTest do
  ...
  @create_attrs %{date: ~N[2010-04-17 14:00:00], description: "some description", title: "some title"}
  @update_attrs %{date: ~N[2011-05-18 15:01:01], description: "some updated description", title: "some updated title"}
